...
export const ImageHistory = ({ generatedImages, onDownload }: ImageHistoryProps) => {
    return (
        <div className="border-t border-gray-300 bg-white px-2 py-3 sm:px-3 sm:py-4">
            <div className="mx-auto max-w-7xl">
                <div className="mb-6 text-center">
                    ...
                    <p className="text-muted-foreground mx-auto max-w-md text-sm">Your image history</p>
                </div>
                ...
                {generatedImages.length > 0 ? (
                            ...
                            <div
                                ...
                                <div className="mb-3 flex items-start justify-between">
                                    <div className="flex items-center gap-2">
                                        <div className="flex h-8 items-center justify-center rounded-full bg-linear-to-r from-blue-500 to-purple-600">
                                ...
                                <p className="mb-3 line-clamp-2 text-xs text-gray-700">{img.prompt}</p>
                    ...
                    <div className="py-16 text-center">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-muted-foreground mx-auto max-w-md text-lg leading-relaxed">Start generate images by entering a prompt</p>
                        </div>
                    </div>
                )}
